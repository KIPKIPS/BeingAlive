...
Shader "Hidden/VacuumShaders/Vertex Color/One Directional Light/Transparent/2 Sided/Bumped Specular"
{
	Properties     
	{                     
		//Rendering Options
	...
	SubShader 
	{
	    ...
	    { 			
			...
			#pragma shader_feature _ V_VC_COLOR_AND_TEXTURE_ON
